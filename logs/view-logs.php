    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?= htmlspecialchars($log['type'] ?? 'N/A', ENT_QUOTES, 'UTF-8') ?>
                </td>
                <td>
                    <?= htmlspecialchars($log['message'] ?? 'N/A', ENT_QUOTES, 'UTF-8') ?>
                </td>
                <td>
                    <?= htmlspecialchars(basename($log['file'] ?? 'N/A'), ENT_QUOTES, 'UTF-8') ?>
                </td>
                <td>
                    <?= htmlspecialchars($log['line'] ?? 'N/A', ENT_QUOTES, 'UTF-8') ?>
                </td>
                <td>
