...
<body id="top" >
    ...
    <main>
        <article>
            <section class="popular" id="destination" style="margin-top: 2%;"></section>
            <div class="container"></div>
            <div style="text-align: center; background-color: #fef6e3; padding-left: 6%; padding-right: 5%; margin-top: -4%; padding-bottom: 20%;">
                <br>
