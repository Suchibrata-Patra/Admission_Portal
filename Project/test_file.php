    ...
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title mb-4">Upload New Images Individually</h5>
                    <table class="table table-bordered">
                        ...
                        <?php for ($i = 1; $i <= 5; $i++): ?>
                            <tr>
                              <td style="text-align: center; vertical-align: middle;"><?php echo $documents[$i-1]; ?></td>
                                      ...
                                      <form action="" method="post" enctype="multipart/form-data">
                                          <div class="mb-3">
                                              <input type="file" class="form-control custom-file-input"
                                                     id="newImage<?php echo $i; ?>"
                                                     name="newImage<?php echo $i; ?>" accept="image/*" onchange="updateFileName(this)">
                                          </div>
