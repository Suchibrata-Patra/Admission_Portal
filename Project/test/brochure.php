...
{
    $pdf->SetFillColor(255, 187, 51); // Grey background color
...
addCellWithoutTopBorder($pdf, 'Return Date:', $returnDate);
...
$pdf->Ln(10); // Add space before authorized signatory
$pdf->SetFont('helvetica', 'B', 10);
// ... (previous code)

// Add signature image
$signaturePath = 'Asset/signature.png'; // Replace with the actual path
...
$pdf->Ln(10); // Add space before amenities
$pdf->SetFont('helvetica', 'B', 12);
$pdf->SetTextColor(0, 113, 227); // Deep Blue Color
$pdf->Cell(0, 10, 'Services Included :', 0, 1, 'L');

// List of amenities (customize based on your offerings)
$amenities = array(
    'Professional Tour Guides',
    'Comfortable Accommodations',
    'Both Side Transportation',
    'Ferry Ticket',
);
...
// Add each amenity to the PDF
foreach ($amenities as $amenity) {
    $pdf->Cell(0, 7, '- ' . $amenity, 0, 1, 'L');
}


$pdf->Ln(0); // Add space after the signature
