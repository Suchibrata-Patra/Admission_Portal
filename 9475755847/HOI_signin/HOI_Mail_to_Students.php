...
$whereClause = "WHERE is_finally_submitted = 1 AND is_Admission_Allowed	=1"; // Always include this condition
   ...
   <?php include 'HOI_Notification_Icon.php'; ?>
                ...
                <div class="head-title">
                    <div class="left">
                        <ul class="breadcrumb">
                            ...
                            <li><a class="active" href="HOI_Mail_to_Students.php">Mail</a></li>
                        </ul>
                    </div>
    ...
    if (isset($filteredResults) && mysqli_num_rows($filteredResults) > 0) {
        ...
        <div class='table-responsive'>
            <form action='HOI_Bunch_Mail_Sender.php' method='POST'>
                <div class='mb-3'>
                    <button type='submit' class='btn btn-primary' name='allow_admission' style='display:none;'>Send Admission Mail</button>
                </div>
                <table class='table'>
                    <thead class='text-xs text-gray-700 uppercase dark:text-gray-400'>
                        <tr class='bg-gray-200'>
                            ...
                            <th class='px-4 py-2 text-center'>Mail Sent</th>
        ...
        while ($row = mysqli_fetch_assoc($filteredResults)) {
            ...
            $admission_status = ($row['Reminder_Email_Sent'] == 1) ? "<span class='badge rounded-pill bg-success' style='font-weight:500;color: white;'>Sent</span>" : "<span class='badge rounded-pill bg-secondary' style='font-weight:500;color:white;'>Not Sent</span>";
