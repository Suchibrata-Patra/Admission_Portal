...
$filteredQuery = "
    SELECT 
        reg_no, fname, lname, email, phoneNumber, dob, terms,
        emailVerify, numberVerify, is_finally_submitted, issubmitted,
...
$headers = array(
    ...
    'physical_science_marks',
    'physical_science_full_marks',
    'life_science_marks',
    'life_science_full_marks',
    'history_marks',
    'history_full_marks',
    'geography_marks',
    'geography_full_marks',
    'obtained_marks',
    'language_1',
    'language_2',
    'select_stream',
