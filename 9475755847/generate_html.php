       ...
       <div>
            ...
            <div>
                <div style="padding-top:2%;">
                    ...
                    <p tyle="font-size: 13px;"> Attention prospective students! It's crucial to stay on top of these
                        ...
                        admission applications. Failure to act promptly may result in forfeiture of your eligibility.
                        Please
            ...
            <ul style="text-align: justify; font-size: 12px;color: grey;">
                <li><b>Refund Policy: </b>Once the Application fees is Submitted It'll no longer Entertained by
                    Refunding
                    the Fees.</li>
                <li><b>Cancellation Procedures: </b>To cancel your application, please contact the admission department
                    at
                    [school's email/phone number]. Please note that cancellation may be subject to certain conditions.
                </li>
            ...
            <p style="text-align: justify; font-size: 12px; color: grey;">
                Congratulations! We're delighted to inform you that your application has been successfully submitted.
                Rest assured, your submission marks the beginning of an exciting journey towards academic excellence.
                From this moment onward, our dedicated team is committed to ensuring that every aspect of your
                application receives the attention it deserves. Your journey with us embodies our shared commitment to
                nurturing talent, fostering growth, and creating a vibrant community of learners. As we embark on this
