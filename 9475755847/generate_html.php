            ...
            <div>
                ...
                <div>
                    <div style="padding-top:2%;">
                        ...
                        <p tyle="font-size: 13px;"> Attention prospective students! It's crucial to stay on top of these
                            important dates for your online
                            admission applications. Failure to act promptly may result in forfeiture of your
                            eligibility.
                            Please
                        ...
                        <h5>
                            <center>Server Log File Details</center>
                        </h5>
                        <table>
                            <tr>
                                <th>Digital Fingerprint ID : </th>
                                <td>
                                    <?php echo $encryptedTimestamp; ?>
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <ul style="text-align: justify; font-size: 12px;color: grey;">
                    <li><b>Refund Policy: </b>Once the Application fees is Submitted It'll no longer Entertained by
                        Refunding
                        the Fees.</li>
                    <li><b>Cancellation Procedures: </b>To cancel your application, please contact the admission
                        department
                        at
                        [school's email/phone number]. Please note that cancellation may be subject to certain
                        conditions.
                    </li>
                    <li><b>Privacy Statement:</b> Your privacy is important to us. We collect and process your personal
                        information in accordance with applicable data protection laws. By submitting your application,
                        you
                        consent to the collection, use, and disclosure of your personal data as described in our Privacy
                        Policy.
                    </li>
                </ul>

                <p style="text-align: justify; font-size: 12px; color: grey;">
                    Congratulations! We're delighted to inform you that your application has been successfully
                    submitted.
                    Rest assured, your submission marks the beginning of an exciting journey towards academic
                    excellence.
                    From this moment onward, our dedicated team is committed to ensuring that every aspect of your
                    application receives the attention it deserves. Your journey with us embodies our shared commitment
                    to
                    nurturing talent, fostering growth, and creating a vibrant community of learners. As we embark on
                    this
                    journey together, we extend our assurance that every step of the way, your aspirations and ambitions
                    will be our top priority. Thank you for choosing us as your partner in education. Assured by
                </p>
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <div style="flex: 1;">
                        <img src="https://i.imgur.com/GlWjPHh.png" alt="Submitted Stamp Pad Image"
                            style="width: 80px; height: auto;padding-left: 30px;">
                    </div>
                    <div style="text-align: right; flex: 1;margin-top: -50px;">
                        <span style="font-weight: bold;font-size: 14px;">
                            <?php echo $school_info['HOI_Name']; ?>
                        </span><br>
